...
class Marketplace2Item {
  ...
  Marketplace2Item.loading() : this(color: Colors.grey, requester_public_key_hash: '...', account: '...', requested_nig: 0,requested_currency: "", requested_amount:0, timestamp:0, payment_ref:"",smart_contract_ref:"",readonly_flag:false,step:0);
