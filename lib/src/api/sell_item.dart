...
class Marketplace1Item {
  ...
  Marketplace1Item.loading() : this(color: Colors.grey, requester_public_key_hash: '...', requester_public_key_hex: '...', requested_nig: 0, requested_amount:0, requested_gap: 0,timestamp:0, payment_ref:"", smart_contract_ref:"",readonly_flag:false,buyer_reput_trans:0,buyer_reput_reliability:0.0);
