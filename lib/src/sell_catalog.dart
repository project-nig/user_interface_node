...
import 'api/sell_fetch.dart';
import 'api/sell_item.dart';
import 'api/sell_page.dart';
...
class SellCatalog extends ChangeNotifier {
  ...
  /// access.
  final Map<int, Marketplace1ItemPage> _pages = {};
  ...
  /// fetched item.
  Marketplace1Item getByIndex(int index) {
    ...
    return Marketplace1Item.loading();
  }
