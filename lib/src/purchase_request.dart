              ...
              children: [
                ...[
                  ...
                  TextFormField(
                    ...
                    decoration: const InputDecoration(
                      filled: true,
                      hintText: "% d'écart en plus au prix de référence",
                      labelText: 'Surcote (défault 0)',
                    ),
                    onChanged: (value) {
                      formData.gap = value;
                    },
                  ...
                  TextButton(
                    ...
                    onPressed: () async {
                      ...
                      if (check_timer=="ok"){
                        ...
                        try{
                          var result_step1 = await launchNigEngine(0,requester_public_key_hash,"fake receiver_public_key_hash","purchase_step1_buy",requested_amount,requested_gap,0,"",requester_public_key_hex,"","","");
                          print('====result purchase_step1_buy=====');
                  ...
                  Expanded(child: Text("Une fois créée, vous pouvez suivre votre demande dans le menu 25_Suivi des Achats de NIG.")),]),
                ].expand(
                  (widget) => [
                    widget,
                    const SizedBox(
