...
import 'api/account_selection_fetch.dart';
import 'api/account_selection_item.dart';
import 'api/account_selection_page.dart';
...
class AccountSelectionCatalog extends ChangeNotifier {
  ...
  /// access.
  final Map<int, AccountSelectionItemPage> _pages = {};
  ...
  /// fetched item.
  AccountSelectionItem getByIndex(int index) {
    ...
    return AccountSelectionItem.loading();
  }
