...
import 'api/purchase_followup_page.dart';
...
class PurchaseFollowUpCatalog extends ChangeNotifier {
  ...
  /// access.
  final Map<int, Marketplace2ItemPage> _pages = {};
  ...
  /// fetched item.
  Marketplace2Item getByIndex(int index) {
    ...
    return Marketplace2Item.loading();
  }
