...
import 'api/sell_followup_fetch.dart';
import 'api/sell_followup_item.dart';
import 'api/sell_followup_page.dart';
...
class SellFollowUpCatalog extends ChangeNotifier {
  ...
  /// access.
  final Map<int, Marketplace3ItemPage> _pages = {};
  ...
  /// fetched item.
  Marketplace3Item getByIndex(int index) {
    ...
    return Marketplace3Item.loading();
  }
