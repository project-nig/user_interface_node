...
import 'api/purchase_fetch.dart';
import 'api/purchase_item.dart';
import 'api/purchase_page.dart';
...
class PurchaseCatalog extends ChangeNotifier {
  ...
  /// access.
  final Map<int, Marketplace1_sellItemPage> _pages = {};
  ...
  /// fetched item.
  Marketplace1_sellItem getByIndex(int index) {
    ...
    return Marketplace1_sellItem.loading();
  }
